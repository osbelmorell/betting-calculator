...
export const parlayCalculatorContent: Record<Locale, ParlayCalculatorContent> = {
  en: {
    ui: {
      ...
      subtitle: 'New to parlays? Build one step by step, then see combined odds and payout update live.',
      quickStartTitle: 'Quick start',
      quickStartSteps: [
        'Set stake amount',
        'Add one or more legs',
        'Watch combined odds and payout update live (all legs must win)',
      ],
      cardTitle: 'Bet & Legs',
      ...
      relatedToolsTitle: 'Related tools and guides',
      relatedToolsBody: 'Learn parlay basics, validate each leg with the odds converter, and compare against a single bet to weigh risk and return.',
  ...
  es: {
    ui: {
      ...
      subtitle: '¿Nuevo en parlays? Crea uno paso a paso y mira la cuota combinada y el pago al instante.',
      quickStartTitle: 'Inicio rápido',
      quickStartSteps: [
