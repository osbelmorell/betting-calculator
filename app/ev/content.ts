...
export const evCalculatorContent: Record<Locale, EvCalculatorCopy> = {
  en: {
    ...
    subtitle: 'New to EV? Enter your bet size, market odds, and your win estimate to see if a bet has long-run value.',
  ...
  es: {
    ...
    subtitle: '¿Nuevo en EV? Ingresa monto, cuota del mercado y tu estimación para saber si hay valor a largo plazo.',
    ...
    quickStartSteps: [
      ...
      'Revisa EV y tu ventaja vs mercado en resultados',
    ],
    cardTitle: 'Entradas',
