...
export const evCalculatorContent: Record<Locale, EvCalculatorCopy> = {
  en: {
    ...
    edge: 'Difference vs Break-Even',
    expectedPayout: 'Profit if Win',
    expectedLoss: 'Loss if Lose',
  ...
  es: {
    ...
    edge: 'Diferencia vs Equilibrio',
    expectedPayout: 'Ganancia si acierta',
    expectedLoss: 'Perdida si falla',
